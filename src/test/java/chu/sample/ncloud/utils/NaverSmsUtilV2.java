...
public class NaverSmsUtilV2 {
	...
	/**
	 * @param 발신자 전화번호 sender
	 * @param 본분 내용 contents
	 * @param 수신자 전화번호 리스트 receiverList
	 */
	public static void sendMessage(String sender, String contents, ArrayList<String> receiverList) {
